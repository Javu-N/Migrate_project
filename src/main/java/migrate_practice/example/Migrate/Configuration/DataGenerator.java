...
import migrate_practice.example.Migrate.Service.DataGeneratorService;
...
public class DataGenerator {
    ...
    @Bean
    CommandLineRunner generateData(LnAccountRepository repository, DataGeneratorService dataGeneratorService) {
        return args -> {
            if (repository.count() == 0) {
                dataGeneratorService.insertFakeData();
            }
        };
    }
//    @Bean
//    CommandLineRunner generateData(LnAccountRepository repository) {
//        return args -> {
//
